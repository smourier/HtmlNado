...
public static class HtmlMicroDataExtensions
{
    ...
    public static readonly Func<string, string> SchemasOrgParser = (type) =>
    {
            ...
            type.StartsWith("https://", StringComparison.OrdinalIgnoreCase)))
        {
            ...
            var pos = type.LastIndexOf(tok, StringComparison.Ordinal);
            if (pos >= 0)
    ...
    public static string GetItemScopePath(this HtmlNode node, string separator, Func<string, string> typeParser = null)
    {
    ...
    public static string GetItemScopeType(this HtmlNode node) => GetItemType(GetItemScope(node));
    ...
    public static string GetItemValue(this HtmlNode node)
    {
        ...
        switch (name)
        {
            ...
            case "time":
                value = node.GetNullifiedAttributeValue("datetime");
                if (value == null)
                {
